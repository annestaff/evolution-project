...
To reproduce this, simply run "CopyOfmain.R" (it is initialised with a seed of 420) for approx. 8h.
...
As in the paper, the relative density starts out pretty chaotically but then stabilises around 1. 
